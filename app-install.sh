...
function show_usage
{
  ...
  echo -n "  "
  outputInfo  "--php"
  echo "       PHP 버전을 [ 53 54 55 56 56 70 71 72 73 74 80 81 ] 형식으로 하나만 입력하세요."
...
if [ ! -f "/usr/bin/php${INPUT_PHP_VERSION}" ]; then
  input_abort "PHP ${INPUT_PHP_VERSION} 버전은 아직 설치되지 않았습니다.  입력 형식) 53 54 55 56 70 71 72 73 74 80 81"
fi
